...
2. **Policy-checked** against your per-agent rules - notional limits, allowed programs, and daily transfer limits
3. **Protocol health-verified** using live vault balance data for Orca, Drift, Kamino, Raydium, Jupiter, and more
