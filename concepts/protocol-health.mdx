...
description: "Prflght monitors live TVL for Orca, Drift, Jupiter, and more. Configure health thresholds to block or pause your agent automatically."
...
Each protocol is assigned a `healthScore` from 0 to 100, where 100 represents a fully healthy protocol. Scores are derived from live on-chain data. Health data feeds directly into the `POST /check` pipeline — you never need to query it separately.
